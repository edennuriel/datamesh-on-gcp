...
resource "null_resource" "gsutil_resources" {
  provisioner "local-exec" {
    command = <<-EOT
      ...
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g merchant-source-configs/dq_merchant_data_product.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g merchant-source-configs/dq_merchant_gcs_data.yaml
      sed -i.bak s/_project_datasto_/${var.project_id_storage}/g merchant-source-configs/dq_merchant_gcs_data.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g customer-source-configs/dq_customer_data_product.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g customer-source-configs/dq_customer_gcs_data.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g customer-source-configs/dq_tokenized_customer_data_product.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g transactions-source-configs/dq_transactions_data_product.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g transactions-source-configs/dq_transactions_gcs_data.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g transactions-consumer-configs/dq_cc_analytics_data_product.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g merchant-source-configs/data-product-classification-tag-auto.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g customer-source-configs/data-product-classification-tag-auto.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g transactions-source-configs/data-product-classification-tag-auto.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g transactions-consumer-configs/data-product-classification-tag-auto.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g merchant-source-configs/data-product-quality-tag-auto.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g customer-source-configs/data-product-quality-tag-auto.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g transactions-source-configs/data-product-quality-tag-auto.yaml
      sed -i.bak s/_project_datagov_/${var.project_id_governance}/g transactions-consumer-configs/data-product-quality-tag-auto.yaml
