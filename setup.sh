...
create_projects() {
  gcloud projects create ${PROJECT_DATAGOV} --organization=${ORG_ID}
  gcloud projects create ${PROJECT_DATASTO} --organization=${ORG_ID}
  gcloud beta billing projects link ${PROJECT_DATAGOV} --billing-account=${BILLING_ID}
  gcloud beta billing projects link ${PROJECT_DATASTO} --billing-account=${BILLING_ID}
}
